...
public class UserFrame extends JFrame {
    ...
    public UserFrame(String name, String pane) throws SQLException {
        SetPane(pane);
    ...
    private void deleteActionPerformed() throws SQLException {
    ...
    private void addUserToCombobox() throws SQLException {
    ...
    private void updateActionPerformed() throws SQLException {
    ...
    private void addActionPerformed() throws SQLException {
    ...
    private void constructUserTable() throws SQLException {
